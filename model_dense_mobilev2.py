...
class Decoder(nn.Module):
    ...
    def forward(self, features):
        x_block0, x_block1, x_block2, x_block3, x_block4, x_block5, x_block6 = features[2], features[4], features[6], \
                                                                               features[9], features[15], features[18], \
                                                                               features[19]
...
class Encoder(nn.Module):
    def __init__(self, pretrained=True, unlabeled=False):
        super(Encoder, self).__init__()
        self.original_model = models.mobilenet_v2(pretrained=pretrained)
...
class Model(nn.Module):
    def __init__(self, pretrained=True, layers=161):
